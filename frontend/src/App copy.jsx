      ...
      <div className="flex flex-1 overflow-hidden">
        {isSidebarOpen && (
          <div className="w-64 bg-gray-50 border-r overflow-y-auto">
            <div className="p-3 font-semibold text-gray-600 border-b">Collections</div>
            <div className="p-3">
              <input
                value={searchTerm}
                onChange={(e) => {
              ...
              {selectedApi && collectionItems.length > 0 ? (
                collectionItems.map((ep) => (
                  <div
                    ...
                    className={`cursor-pointer hover:bg-gray-200 p-2 rounded ${selectedEndpoint === ep.name ? 'bg-blue-100 font-semibold' : ''}`}
                  >
                    {ep.name}
                  </div>
                ))
                ...
                apiNames
                  ...
                  .map((name) => (
                    <div
                      ...
                      className={`cursor-pointer hover:bg-gray-200 p-2 rounded ${selectedApi === name ? 'bg-blue-100 font-semibold' : ''}`}
                    >
                      {name}
                    </div>
                  ))
